		...
		<div class="morebt">
			<div class="cztable">
				<form action="StaffServlet?method=add" method="post">
					...
					<p>&nbsp;</p>
					<div align="center">
						<input type="submit" id="button" value="提交"  style="width:400px;border-radius:9px;height:35px;margin-left:-20px" onmouseover="this.style.backgroundColor='#99CC99';" onmouseout="this.style.backgroundColor='';" />
					</div>
				</form>
			</div>
		</div>
