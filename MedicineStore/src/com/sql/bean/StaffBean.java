...
public class StaffBean {
	...
	public StaffBean(int id, int staffId, String staffName, String sex, int age, String tel, String duty, float workingAge,String born,String nation,String major,String edu,String degree1,String loca,String email,String pict) {
		super();
		this.id = id;
